describe('Ship placement', function() {
  ...
  it('Adds a ship to the grid', () => {
    ...
    cy.get('#owner-square-55').click()
    cy.get('#owner-square-55').should('have.class', 'square-ship')
    cy.get('#owner-square-56').should('have.class', 'square-ship')
    cy.get('#owner-square-57').should('have.class', 'square-ship')
    cy.get('#owner-square-58').should('have.class', 'square-ship')
    cy.get('#owner-square-59').should('have.class', 'square-ship')
  })
